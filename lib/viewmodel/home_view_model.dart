...
class HomeViewModel extends ChangeNotifier {
  ...
  void matrixSlide (int index) {
    if(index == currPageValue.floor()) {
      ...
      _matrix = Matrix4.diagonal3Values(1,currScale, 1)..setTranslationRaw(0, curTrans, 0);
      ...
      var currScale = 0.8;
      _matrix = Matrix4.diagonal3Values(1,currScale, 1)..setTranslationRaw(0, _height*(1-_scaleFactor)/2, 1);
    }
  }
