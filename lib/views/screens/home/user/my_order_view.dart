                ...
                children: [
                  ...
                  Expanded(
                      ...
                      orderViewModel.orderList.isEmpty
                          ...
                          : _buildListOrder(false, orderViewModel.orderList),
                      Column(
                        children: [
                          Align(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Icon(Icons.calendar_today,size: DimensManager.dimens.setSp(24), color: UIColors.white,)
                                  ],
                                )
                              ),
                            ),
                          ...
                          Expanded(
                              child: _buildListOrder(true, orderViewModel.orderListFinish)
                          )
                        ],
                      ),
                    ],
                  ...
                  flex: 1,
                    child: Container(
                      padding: EdgeInsets.only(
                        ...
                        child: UIText(UIStrings.rate, color: UIColors.primary, decoration: TextDecoration.underline,),
                    )
                ) : Container()
              ],
            )
